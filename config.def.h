...
#define TAGKEYS(KEY,TAG) \
        ...
        { MODKEY, Button4, view, {.ui = 1 << 0 } }, \ // Mod4 + Scroll Up para Tag 1
        { MODKEY, Button5, view, {.ui = 1 << 1 } }, // Mod4 + Scroll Down para Tag 2
...
static const Key keys[] = {
        ...
        { MODKEY|ControlMask,           XK_d,      setlayout,      {.v = &layouts[2]} },
        ...
        { MODKEY|ControlMask,           XK_j,      setlayout,      {.v = &layouts[6]} },
        { MODKEY|ControlMask,           XK_k,      setlayout,      {.v = &layouts[7]} },
        { MODKEY|ControlMask,           XK_l,      setlayout,      {.v = &layouts[8]} },
        { MODKEY|ControlMask,           XK_b,      setlayout,      {.v = &layouts[9]} },
        { MODKEY|ControlMask,           XK_z,      setlayout,      {.v = &layouts[10]} },
        { MODKEY|ControlMask,           XK_x,      setlayout,      {.v = &layouts[11]} },
        { MODKEY|ControlMask,           XK_c,      setlayout,      {.v = &layouts[12]} },
        { MODKEY|ControlMask,           XK_v,      setlayout,      {.v = &layouts[13]} },
